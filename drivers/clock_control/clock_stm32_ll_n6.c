					       ...
					       uint32_t *rate)
{
	...
	uint32_t apb4_clock = get_bus_clock(ahb_clock, STM32_APB4_PRESCALER);
	uint32_t apb5_clock = get_bus_clock(ahb_clock, STM32_APB5_PRESCALER);
